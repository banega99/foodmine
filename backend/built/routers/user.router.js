...
router.post("/login", (0, express_async_handler_1["default"])(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = req.body // requ.body prepoznaje varijable i dodeljuje im vrednosti na osnovu naziva kljuca koji se podudara sa nazivom varijabli 
                , email = _a.email, password = _a.password;
                return [4 /*yield*/, user_model_1.UserModel.findOne({ email: email })]; // umesto body.email i body.password koristimo email i password koji smo definisali u prethodnoj liniji
            case 1:
                user = _c.sent() // umesto body.email i body.password koristimo email i password koji smo definisali u prethodnoj liniji
                ;
                _b = user;
